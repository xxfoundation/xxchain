...
pub mod pallet {
    ...
    impl<T: Config> BuildGenesisConfig for GenesisConfig<T> {
        fn build(&self) {
            ...
            let _ = <CurrencyOf<T>>::make_free_balance_be(&testnet_account_id, self.testnet_balance);
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn set_testnet_manager_account(origin: OriginFor<T>, who: T::AccountId) -> DispatchResult {
