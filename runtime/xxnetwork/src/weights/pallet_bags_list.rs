...
// pallet_bags_list
// --extrinsic
// rebag_non_terminal,rebag_terminal,put_in_front_of
// --steps
// 50
// --repeat
// 20
...
// 4096
// --output
// runtime/xxnetwork/src/weights/pallet_bags_list.rs
...
impl<T: frame_system::Config> pallet_bags_list::WeightInfo for WeightInfo<T> {
	...
	/// Placeholder: on_idle does nothing when MaxAutoRebagPerBlock = 0
	/// This function is never called in production since auto-rebagging is disabled.
	fn on_idle() -> Weight {
