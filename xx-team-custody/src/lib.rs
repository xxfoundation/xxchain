...
use alloc::vec::Vec;
use frame_support::traits::{fungible::Inspect, Currency, Get};
...
pub mod pallet {
	...
	pub type CustodyAccounts<T: Config> =
...
pub use pallet::{
	Config, Custodians, CustodyAccounts, Error, Event, GenesisConfig, Pallet, TeamAccounts,
	TotalCustody,
};
